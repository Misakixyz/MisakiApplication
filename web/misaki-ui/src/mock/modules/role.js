    ...
    "data": [
      {
        "id": 1,
        "createBy": "admin",
        "createTime": "2022-08-14T03:11:11.000+0000",
        "lastUpdateBy": "admin",
        "lastUpdateTime": "2022-08-14T03:11:11.000+0000",
        "name": "admin",
        "remark": "超级管理员",
        "delFlag": 0
      },
...
export function getContent(pageNum, pageSize) {
  ...
  for(let i=0; i<pageSize; i++) {
    ...
    obj.createBy= 'admin'
    obj.createTime= '2022-08-14 11:11:11'
    obj.createBy= 'admin'
    obj.createTime= '2022-09-14 12:12:12'
    content.push(obj)
  }
  return content
}
